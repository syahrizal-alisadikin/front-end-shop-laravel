    ...
    <div class="container mt-5 mb-5">
        <div class="row">
            <div class="col-md-4">
                <div class="card border-0 rounded shadow">
                    <div class="card-body p-2">
                        <img :src="product.image"  alt="gambar" class="w-100 border">
                    </div>
                </div>
            </div>
            ...
            <div class="col-md-8">
                <div class="card border-0 rounded shadow">
                    <div class="card-body">
                        <label style="font-size:20px" class="font-weight-bold"> {{product.title}} </label>
                        <hr>
...
<script>
import { computed,onMounted } from 'vue' //computed dan onMounted Hook Dari Vue
